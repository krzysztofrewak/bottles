...
def collect_statistics(filters):
    ...
    return total_images, attribute_counts, combination_counts, parsing_errors


def print_statistics(filters):
    total, attribute_counts, combination_counts, parsing_errors = collect_statistics(filters)
